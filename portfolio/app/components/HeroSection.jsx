...
const HeroSection =() =>{
    return(
        ...
        <div className="grid grid-cols-1 sm:grid-cols-12">
            <div className="col-span-7 place-self-center text-center sm:text-left justify-self-start md:pl-8">
    ...
    />
                        ...
                        <div>
                            ...
                            className="px-1 py-1 w-full sm:w-fit rounded-full  bg-gradient-to-br from-amber-500 via-red-500 to-purple-500 hover:bg-slate-800 text-white mt-3">
